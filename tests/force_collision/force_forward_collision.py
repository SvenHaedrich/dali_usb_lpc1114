...
def send_spaced_backframes(spacing_us):
    ...
    serial_0_port.write("S1 10 0000\r".encode("utf-8"))
    time.sleep(spacing_us * mu_sec)
    serial_1_port.write("S1 10 FFFF\r".encode("utf-8"))
    time.sleep(0.2)


print("FORCE FORWARD FRAME COLLISION")
